...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 07-06-2023 a las 00:44:40
...
(1, 'Losas D´Casster´s', '', NULL, NULL, 'contacto@losasdcassers.com', 'jortiz@sektor.com.mx', 'alexis@wozial.com', '2P2lYvtSAZX9', 'mail.wozial.com', '465', NULL, '3331884040, 3331883180', '3318940000', '', 'https://www.facebook.com/sektoralarmas', '', NULL, NULL, NULL, NULL, NULL, NULL, '<iframe src=\"https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3732.84572216016!2d-103.3837752!3d20.675854700000002!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8428ae6d6d5fd08d%3A0x439d71abb16f0dda!2sSektor!5e0!3m2!1ses-419!2smx!4v1668797393100!5m2!1ses-419!2smx\" width=\"600\" height=\"450\" style=\"border:0;\" allowfullscreen=\"\" loading=\"lazy\" referrerpolicy=\"no-referrer-when-downgrade\"></iframe>', 'C. Volcán Vesubio 6579, Colli Urbano 45070 Zapopan, Jal.', NULL, '2023-06-07 00:48:48');
...
(123, 'Portada', 'Empresas que llevan nuestro producto', 'wJmmOkSNwu0MDIlezXF1gWnUREzRWq.jpg', NULL, 1, 1, 666, 4),
...
(1, 'Test', '<p>Respuesta test</p>', 666, '2023-06-07 04:18:53', '2023-06-07 04:18:53');
...
(1, 'aviso de privacidad', '<p>AVISO DE PRIVACIDAD</p>', NULL, NULL, '2023-06-07 04:21:25'),
(2, 'metodos de pago', '<p>NO APLICA PARA ESTA P&Aacute;GINA</p>', NULL, NULL, '2023-06-07 04:21:03'),
(3, 'devoluciones', '<p>NO APLICA PARA ESTA P&Aacute;GINA</p>', NULL, NULL, '2023-06-07 04:20:27'),
(4, 'terminos y condiciones', '<p>TERMINOS Y CONDICIONES</p>', NULL, NULL, '2023-06-07 04:21:14'),
(5, 'garantias', '<p>NO APLICA PARA ESTA P&Aacute;GINA</p>', NULL, NULL, '2023-06-07 04:20:34'),
...
(1, NULL, 'uno', 'gPVc1AzYlf617GaizgkDPkFNteI6Bi.jpeg', NULL, '2023-06-03 00:01:31', '2023-06-06 20:18:11'),
...
INSERT INTO `respaldos` (`id`, `foto`, `aux`, `created_at`, `updated_at`) VALUES
(3, '2iiv2QnizzT1eYnPsl6XoLPYlvoGIn.png', NULL, '2023-06-06 20:39:48', '2023-06-06 20:39:48'),
(4, 'YoUnUFBfME1aaZ4PXgHcgypLtkqM6A.png', NULL, '2023-06-06 20:40:01', '2023-06-06 20:40:01'),
(5, 'sw4w4AmRUPhXG6KiNxVdfAbeutGPdg.png', NULL, '2023-06-06 20:40:10', '2023-06-06 20:40:10'),
(6, 'h5yih7HSbbrZOFuLZ3mlOc2G0IOJTA.png', NULL, '2023-06-06 20:40:21', '2023-06-06 20:40:21');
...
--
-- Estructura de tabla para la tabla `ventajas_usos`
--

CREATE TABLE `ventajas_usos` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `texto` text DEFAULT NULL,
  `aux` text DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
...
--
-- Volcado de datos para la tabla `ventajas_usos`
--

INSERT INTO `ventajas_usos` (`id`, `texto`, `aux`, `created_at`, `updated_at`) VALUES
(1, 'AISLAMIENTO TÉRMICO', NULL, '2023-06-06 21:41:29', '2023-06-06 22:14:25'),
(4, 'INCOMBUSTIBLE', NULL, '2023-06-06 21:51:55', '2023-06-06 21:51:55'),
(5, 'AISLAMIENTO ACÚSTICO', NULL, '2023-06-06 21:52:06', '2023-06-06 21:52:06'),
(6, 'RECIBE CUALQUIER TIPO DE IMPERMEABILIZANTE', NULL, '2023-06-06 21:52:23', '2023-06-06 22:14:15'),
(7, 'ULTRA LIGERO', NULL, '2023-06-06 21:52:34', '2023-06-06 21:52:34'),
(8, 'PROPORCIONA PENDIENTES Y RELLENA HUECOS', NULL, '2023-06-06 21:52:49', '2023-06-06 21:52:49'),
(9, 'FÁCIL DE APICAR', NULL, '2023-06-06 21:52:58', '2023-06-06 21:52:58'),
(10, 'NO SE PUDRE NI SE DEGRADA', NULL, '2023-06-06 21:53:07', '2023-06-06 21:53:07'),
(12, 'SU TIEMPO DE VIDA ES ILIMITADO', NULL, '2023-06-06 22:28:50', '2023-06-06 22:28:50');
...
--
-- Indices de la tabla `ventajas_usos`
--
ALTER TABLE `ventajas_usos`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT de la tabla `ventajas_usos`
--
ALTER TABLE `ventajas_usos`
