			...
			<div class="index" style="padding-top: 0; background: #F7F7F7;">
				<div class="servicios">
							...
							<div class="col-12 p-0 m-0 d-flex justify-content-center" style="">
									...
									<div class="col-12 row d-flex justify-content-center" style="max-width: 1870px;">

										<div class="col-12 col-md-12 col-lg-6 ps-md-5 pe-md-0 pe-lg-5 d-flex justify-content-sm-center justify-content-md-center " style="padding-top: 150px;">
											<div class="col-12" style="background: white; border-radius: 30px ; box-shadow: 1px 1px 15px 3px rgba(0, 0, 0, 0.2); max-width: 900px; height: 850px;">
												<div class="ContTextCuadroServ">
													<h1>{{$serv->nombre}}</h1>
													<div class="LineRserviceC mt-2"></div>

													<div class="col-12 col-md-12 col-lg-6 row pt-4 d-flex justify-content-center" style=" height: 200px;  ">
														<div class="carousel col-12 ms-4" style=" min-width: 150px;">
															@if (!empty($photo_product->count()))
															@foreach ($photo_product as $photosP)
															
															<img src="{{ asset('img/photos/productos/'.$photosP->image)}}" class="img-slik"  style="width: 400px; max-height: 200px; background: cover;">
															
															@endforeach
															
															@else
															
															<img src="{{ asset('img/design/police.png')}}" alt="police"  class="img-slik"  style=" width: 470px;  max-height: 470px;">
															<img src="{{ asset('img/design/police.png')}}" alt="police"  class="img-slik"  style=" width: 470px;  max-height: 470px;">
													...
													<div class="divBtnCuadro">
														<a href="https://wa.me/52{{$config->whatsapp}}?text=Hola! estoy interesado en el servicio de {{$serv->nombre}}"><button style="height: 40px;">CONTRATAR</button></a>
													</div>
												</div>
											</div>
										</div>
				...
				<div class="seccion3">
					...
					<div class="col-12 col-md-12 col-lg-12" style="height: 90%;">
						<div class="col-12 col-md-12 col-lg-11 text-center d-flex justify-content-end" style="height: 100%; align-items: center;">
							...
							<form action="{{route('formularioContac')}}" class="form-solicita col-12 col-md-12 col-lg-5" method="POST">
								@csrf
