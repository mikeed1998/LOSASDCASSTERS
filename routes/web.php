...
Route::name('front.')->group(function(){
	...
	Route::get('losas', 'FrontController@losas')->name('losas');
	Route::get('perlita', 'FrontController@perlita')->name('perlita');
...
Route::prefix('admin')->group(function(){
	...
	Route::prefix('config')->name('config.')->group(function(){
		...
		Route::prefix('secciones')->name('seccion.')->group(function(){
			...
			/////////////////////////////////////// PROYECTOS /////////////////////////////////////// 
			Route::post('/proyectosSlider','SeccionController@proyectosSlider')->name('proyectosSlider');
